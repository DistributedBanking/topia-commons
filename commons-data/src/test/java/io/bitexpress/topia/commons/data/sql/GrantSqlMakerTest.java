...
public class GrantSqlMakerTest {
    ...
    public void getParam() throws IOException {
        Param param = GrantSqlMaker.getParam("create sequence fxbtg.seq_operator_create_order", "user");
    ...
    public void grantTable() throws IOException {
        Param param = GrantSqlMaker.getParam("create table fxbtg.t_operator_create_order", "user");
        List<String> grant = GrantSqlMaker.grant(param);
        System.out.println(grant);
    }
